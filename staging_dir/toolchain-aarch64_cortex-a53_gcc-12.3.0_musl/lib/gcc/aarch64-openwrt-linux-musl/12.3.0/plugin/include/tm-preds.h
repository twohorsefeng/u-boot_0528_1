/* Generated automatically by the program 'build/genpreds'
   from the machine description file '/builder/shared-workdir/build/build_dir/toolchain-aarch64_cortex-a53_gcc-12.3.0_musl/gcc-12.3.0/gcc/config/aarch64/aarch64.md'.  */
