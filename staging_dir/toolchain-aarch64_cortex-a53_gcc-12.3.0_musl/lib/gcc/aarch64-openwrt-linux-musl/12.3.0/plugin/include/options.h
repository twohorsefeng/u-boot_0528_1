...
enum opt_code
{
  ...
  OPT_fhonour_copts = 1209,                  /* -fhonour-copts */
  OPT_fhosted = 1210,                        /* -fhosted */
  OPT_fhuge_objects = 1211,                  /* -fhuge-objects */
  OPT_fident = 1212,                         /* -fident */
  OPT_fif_conversion = 1213,                 /* -fif-conversion */
  OPT_fif_conversion2 = 1214,                /* -fif-conversion2 */
  OPT_fignore_unknown_pragmas = 1215,        /* -fignore-unknown-pragmas */
  OPT_fimplement_inlines = 1216,             /* -fimplement-inlines */
  OPT_fimplicit_constexpr = 1217,            /* -fimplicit-constexpr */
  OPT_fimplicit_inline_templates = 1218,     /* -fimplicit-inline-templates */
  OPT_fimplicit_none = 1219,                 /* -fimplicit-none */
  OPT_fimplicit_templates = 1220,            /* -fimplicit-templates */
  OPT_findirect_inlining = 1221,             /* -findirect-inlining */
  OPT_finhibit_size_directive = 1222,        /* -finhibit-size-directive */
  OPT_finit_character_ = 1223,               /* -finit-character= */
  OPT_finit_derived = 1224,                  /* -finit-derived */
  OPT_finit_integer_ = 1225,                 /* -finit-integer= */
  OPT_finit_local_zero = 1226,               /* -finit-local-zero */
  OPT_finit_logical_ = 1227,                 /* -finit-logical= */
  OPT_finit_real_ = 1228,                    /* -finit-real= */
  OPT_finline = 1229,                        /* -finline */
  OPT_finline_arg_packing = 1230,            /* -finline-arg-packing */
  OPT_finline_atomics = 1231,                /* -finline-atomics */
  OPT_finline_functions = 1232,              /* -finline-functions */
  OPT_finline_functions_called_once = 1233,  /* -finline-functions-called-once */
  /* OPT_finline_limit_ = 1234, */           /* -finline-limit- */
  OPT_finline_limit_ = 1235,                 /* -finline-limit= */
  OPT_finline_matmul_limit_ = 1236,          /* -finline-matmul-limit= */
  OPT_finline_small_functions = 1237,        /* -finline-small-functions */
  OPT_finput_charset_ = 1238,                /* -finput-charset= */
  OPT_finstrument_functions = 1239,          /* -finstrument-functions */
  OPT_finstrument_functions_exclude_file_list_ = 1240,/* -finstrument-functions-exclude-file-list= */
  OPT_finstrument_functions_exclude_function_list_ = 1241,/* -finstrument-functions-exclude-function-list= */
  OPT_finteger_4_integer_8 = 1242,           /* -finteger-4-integer-8 */
  OPT_fintrinsic_modules_path = 1243,        /* -fintrinsic-modules-path */
  OPT_fintrinsic_modules_path_ = 1244,       /* -fintrinsic-modules-path= */
  OPT_finvariants = 1245,                    /* -finvariants */
  OPT_fipa_bit_cp = 1246,                    /* -fipa-bit-cp */
  OPT_fipa_cp = 1247,                        /* -fipa-cp */
  /* OPT_fipa_cp_alignment = 1248, */        /* -fipa-cp-alignment */
  OPT_fipa_cp_clone = 1249,                  /* -fipa-cp-clone */
  OPT_fipa_icf = 1250,                       /* -fipa-icf */
  OPT_fipa_icf_functions = 1251,             /* -fipa-icf-functions */
  OPT_fipa_icf_variables = 1252,             /* -fipa-icf-variables */
  /* OPT_fipa_matrix_reorg = 1253, */        /* -fipa-matrix-reorg */
  OPT_fipa_modref = 1254,                    /* -fipa-modref */
  OPT_fipa_profile = 1255,                   /* -fipa-profile */
  OPT_fipa_pta = 1256,                       /* -fipa-pta */
  OPT_fipa_pure_const = 1257,                /* -fipa-pure-const */
  OPT_fipa_ra = 1258,                        /* -fipa-ra */
  OPT_fipa_reference = 1259,                 /* -fipa-reference */
  OPT_fipa_reference_addressable = 1260,     /* -fipa-reference-addressable */
  OPT_fipa_sra = 1261,                       /* -fipa-sra */
  OPT_fipa_stack_alignment = 1262,           /* -fipa-stack-alignment */
  OPT_fipa_strict_aliasing = 1263,           /* -fipa-strict-aliasing */
  /* OPT_fipa_struct_reorg = 1264, */        /* -fipa-struct-reorg */
  OPT_fipa_vrp = 1265,                       /* -fipa-vrp */
  OPT_fira_algorithm_ = 1266,                /* -fira-algorithm= */
  OPT_fira_hoist_pressure = 1267,            /* -fira-hoist-pressure */
  OPT_fira_loop_pressure = 1268,             /* -fira-loop-pressure */
  OPT_fira_region_ = 1269,                   /* -fira-region= */
  OPT_fira_share_save_slots = 1270,          /* -fira-share-save-slots */
  OPT_fira_share_spill_slots = 1271,         /* -fira-share-spill-slots */
  OPT_fira_verbose_ = 1272,                  /* -fira-verbose= */
  OPT_fisolate_erroneous_paths_attribute = 1273,/* -fisolate-erroneous-paths-attribute */
  OPT_fisolate_erroneous_paths_dereference = 1274,/* -fisolate-erroneous-paths-dereference */
  OPT_fivar_visibility_ = 1275,              /* -fivar-visibility= */
  OPT_fivopts = 1276,                        /* -fivopts */
  OPT_fjump_tables = 1277,                   /* -fjump-tables */
  OPT_fkeep_gc_roots_live = 1278,            /* -fkeep-gc-roots-live */
  OPT_fkeep_inline_dllexport = 1279,         /* -fkeep-inline-dllexport */
  OPT_fkeep_inline_functions = 1280,         /* -fkeep-inline-functions */
  OPT_fkeep_static_consts = 1281,            /* -fkeep-static-consts */
  OPT_fkeep_static_functions = 1282,         /* -fkeep-static-functions */
  OPT_flabels_ok = 1283,                     /* -flabels-ok */
  OPT_flang_info_include_translate = 1284,   /* -flang-info-include-translate */
  OPT_flang_info_include_translate_not = 1285,/* -flang-info-include-translate-not */
  OPT_flang_info_include_translate_ = 1286,  /* -flang-info-include-translate= */
  OPT_flang_info_module_cmi = 1287,          /* -flang-info-module-cmi */
  OPT_flang_info_module_cmi_ = 1288,         /* -flang-info-module-cmi= */
  OPT_flarge_source_files = 1289,            /* -flarge-source-files */
  OPT_flax_vector_conversions = 1290,        /* -flax-vector-conversions */
  OPT_fleading_underscore = 1291,            /* -fleading-underscore */
  OPT_flifetime_dse = 1292,                  /* -flifetime-dse */
  OPT_flifetime_dse_ = 1293,                 /* -flifetime-dse= */
  OPT_flimit_function_alignment = 1294,      /* -flimit-function-alignment */
  OPT_flinker_output_ = 1295,                /* -flinker-output= */
  /* OPT_flive_patching = 1296, */           /* -flive-patching */
  OPT_flive_patching_ = 1297,                /* -flive-patching= */
  OPT_flive_range_shrinkage = 1298,          /* -flive-range-shrinkage */
  OPT_flocal_ivars = 1299,                   /* -flocal-ivars */
  /* OPT_floop_block = 1300, */              /* -floop-block */
  /* OPT_floop_flatten = 1301, */            /* -floop-flatten */
  OPT_floop_interchange = 1302,              /* -floop-interchange */
  OPT_floop_nest_optimize = 1303,            /* -floop-nest-optimize */
  /* OPT_floop_optimize = 1304, */           /* -floop-optimize */
  OPT_floop_parallelize_all = 1305,          /* -floop-parallelize-all */
  /* OPT_floop_strip_mine = 1306, */         /* -floop-strip-mine */
  OPT_floop_unroll_and_jam = 1307,           /* -floop-unroll-and-jam */
  OPT_flra_remat = 1308,                     /* -flra-remat */
  OPT_flto = 1309,                           /* -flto */
  OPT_flto_compression_level_ = 1310,        /* -flto-compression-level= */
  /* OPT_flto_odr_type_merging = 1311, */    /* -flto-odr-type-merging */
  OPT_flto_partition_ = 1312,                /* -flto-partition= */
  OPT_flto_report = 1313,                    /* -flto-report */
  OPT_flto_report_wpa = 1314,                /* -flto-report-wpa */
  OPT_flto_ = 1315,                          /* -flto= */
  OPT_fltrans = 1316,                        /* -fltrans */
  OPT_fltrans_output_list_ = 1317,           /* -fltrans-output-list= */
  OPT_fmacro_prefix_map_ = 1318,             /* -fmacro-prefix-map= */
  OPT_fmain = 1319,                          /* -fmain */
  OPT_fmath_errno = 1320,                    /* -fmath-errno */
  OPT_fmax_array_constructor_ = 1321,        /* -fmax-array-constructor= */
  OPT_fmax_errors_ = 1322,                   /* -fmax-errors= */
  OPT_fmax_identifier_length_ = 1323,        /* -fmax-identifier-length= */
  OPT_fmax_include_depth_ = 1324,            /* -fmax-include-depth= */
  OPT_fmax_stack_var_size_ = 1325,           /* -fmax-stack-var-size= */
  OPT_fmax_subrecord_length_ = 1326,         /* -fmax-subrecord-length= */
  OPT_fmem_report = 1327,                    /* -fmem-report */
  OPT_fmem_report_wpa = 1328,                /* -fmem-report-wpa */
  OPT_fmerge_all_constants = 1329,           /* -fmerge-all-constants */
  OPT_fmerge_constants = 1330,               /* -fmerge-constants */
  OPT_fmerge_debug_strings = 1331,           /* -fmerge-debug-strings */
  OPT_fmessage_length_ = 1332,               /* -fmessage-length= */
  OPT_fmodule_file_ = 1333,                  /* -fmodule-file= */
  OPT_fmodule_header = 1334,                 /* -fmodule-header */
  OPT_fmodule_header_ = 1335,                /* -fmodule-header= */
  OPT_fmodule_implicit_inline = 1336,        /* -fmodule-implicit-inline */
  OPT_fmodule_lazy = 1337,                   /* -fmodule-lazy */
  OPT_fmodule_mapper_ = 1338,                /* -fmodule-mapper= */
  OPT_fmodule_only = 1339,                   /* -fmodule-only */
  OPT_fmodule_private = 1340,                /* -fmodule-private */
  OPT_fmodule_version_ignore = 1341,         /* -fmodule-version-ignore */
  OPT_fmoduleinfo = 1342,                    /* -fmoduleinfo */
  OPT_fmodules_ts = 1343,                    /* -fmodules-ts */
  OPT_fmodulo_sched = 1344,                  /* -fmodulo-sched */
  OPT_fmodulo_sched_allow_regmoves = 1345,   /* -fmodulo-sched-allow-regmoves */
  OPT_fmove_loop_invariants = 1346,          /* -fmove-loop-invariants */
  OPT_fmove_loop_stores = 1347,              /* -fmove-loop-stores */
  OPT_fms_extensions = 1348,                 /* -fms-extensions */
  OPT_fmudflap = 1349,                       /* -fmudflap */
  OPT_fmudflapir = 1350,                     /* -fmudflapir */
  OPT_fmudflapth = 1351,                     /* -fmudflapth */
  OPT_fname_mangling_version_ = 1352,        /* -fname-mangling-version- */
  OPT_fnew_abi = 1353,                       /* -fnew-abi */
  OPT_fnew_inheriting_ctors = 1354,          /* -fnew-inheriting-ctors */
  OPT_fnew_ttp_matching = 1355,              /* -fnew-ttp-matching */
  OPT_fnext_runtime = 1356,                  /* -fnext-runtime */
  OPT_fnil_receivers = 1357,                 /* -fnil-receivers */
  OPT_fno_modules = 1358,                    /* -fno-modules */
  OPT_fnon_call_exceptions = 1359,           /* -fnon-call-exceptions */
  OPT_fnonansi_builtins = 1360,              /* -fnonansi-builtins */
  OPT_fnonnull_objects = 1361,               /* -fnonnull-objects */
  OPT_fnothrow_opt = 1362,                   /* -fnothrow-opt */
  OPT_fobjc_abi_version_ = 1363,             /* -fobjc-abi-version= */
  OPT_fobjc_call_cxx_cdtors = 1364,          /* -fobjc-call-cxx-cdtors */
  OPT_fobjc_direct_dispatch = 1365,          /* -fobjc-direct-dispatch */
  OPT_fobjc_exceptions = 1366,               /* -fobjc-exceptions */
  OPT_fobjc_gc = 1367,                       /* -fobjc-gc */
  OPT_fobjc_nilcheck = 1368,                 /* -fobjc-nilcheck */
  OPT_fobjc_sjlj_exceptions = 1369,          /* -fobjc-sjlj-exceptions */
  OPT_fobjc_std_objc1 = 1370,                /* -fobjc-std=objc1 */
  OPT_foffload_abi_ = 1371,                  /* -foffload-abi= */
  OPT_foffload_options_ = 1372,              /* -foffload-options= */
  OPT_foffload_ = 1373,                      /* -foffload= */
  OPT_fomit_frame_pointer = 1374,            /* -fomit-frame-pointer */
  OPT_fonly_ = 1375,                         /* -fonly= */
  OPT_fopenacc = 1376,                       /* -fopenacc */
  OPT_fopenacc_dim_ = 1377,                  /* -fopenacc-dim= */
  OPT_fopenmp = 1378,                        /* -fopenmp */
  OPT_fopenmp_simd = 1379,                   /* -fopenmp-simd */
  OPT_foperator_names = 1380,                /* -foperator-names */
  OPT_fopt_info = 1381,                      /* -fopt-info */
  OPT_fopt_info_ = 1382,                     /* -fopt-info- */
  /* OPT_foptimize_register_move = 1383, */  /* -foptimize-register-move */
  OPT_foptimize_sibling_calls = 1384,        /* -foptimize-sibling-calls */
  OPT_foptimize_strlen = 1385,               /* -foptimize-strlen */
  /* OPT_foptional_diags = 1386, */          /* -foptional-diags */
  OPT_fpack_derived = 1387,                  /* -fpack-derived */
  OPT_fpack_struct = 1388,                   /* -fpack-struct */
  OPT_fpack_struct_ = 1389,                  /* -fpack-struct= */
  OPT_fpad_source = 1390,                    /* -fpad-source */
  OPT_fpartial_inlining = 1391,              /* -fpartial-inlining */
  OPT_fpatchable_function_entry_ = 1392,     /* -fpatchable-function-entry= */
  OPT_fpcc_struct_return = 1393,             /* -fpcc-struct-return */
  OPT_fpch_deps = 1394,                      /* -fpch-deps */
  OPT_fpch_preprocess = 1395,                /* -fpch-preprocess */
  OPT_fpeel_loops = 1396,                    /* -fpeel-loops */
  OPT_fpeephole = 1397,                      /* -fpeephole */
  OPT_fpeephole2 = 1398,                     /* -fpeephole2 */
  OPT_fpermissive = 1399,                    /* -fpermissive */
  OPT_fpermitted_flt_eval_methods_ = 1400,   /* -fpermitted-flt-eval-methods= */
  OPT_fpic = 1401,                           /* -fpic */
  OPT_fpie = 1402,                           /* -fpie */
  OPT_fplan9_extensions = 1403,              /* -fplan9-extensions */
  OPT_fplt = 1404,                           /* -fplt */
  OPT_fplugin_arg_ = 1405,                   /* -fplugin-arg- */
  OPT_fplugin_ = 1406,                       /* -fplugin= */
  OPT_fpost_ipa_mem_report = 1407,           /* -fpost-ipa-mem-report */
  OPT_fpostconditions = 1408,                /* -fpostconditions */
  OPT_fpre_include_ = 1409,                  /* -fpre-include= */
  OPT_fpre_ipa_mem_report = 1410,            /* -fpre-ipa-mem-report */
  OPT_fpreconditions = 1411,                 /* -fpreconditions */
  OPT_fpredictive_commoning = 1412,          /* -fpredictive-commoning */
  OPT_fprefetch_loop_arrays = 1413,          /* -fprefetch-loop-arrays */
  OPT_fpreprocessed = 1414,                  /* -fpreprocessed */
  OPT_fpretty_templates = 1415,              /* -fpretty-templates */
  OPT_fpreview_all = 1416,                   /* -fpreview=all */
  OPT_fpreview_dip1000 = 1417,               /* -fpreview=dip1000 */
  OPT_fpreview_dip1008 = 1418,               /* -fpreview=dip1008 */
  OPT_fpreview_dip1021 = 1419,               /* -fpreview=dip1021 */
  OPT_fpreview_dip25 = 1420,                 /* -fpreview=dip25 */
  OPT_fpreview_dtorfields = 1421,            /* -fpreview=dtorfields */
  OPT_fpreview_fieldwise = 1422,             /* -fpreview=fieldwise */
  OPT_fpreview_fixaliasthis = 1423,          /* -fpreview=fixaliasthis */
  ...
  OPT_frevert_markdown = 1491,               /* -frevert=markdown */
  OPT_frounding_math = 1492,                 /* -frounding-math */
  OPT_frtti = 1493,                          /* -frtti */
